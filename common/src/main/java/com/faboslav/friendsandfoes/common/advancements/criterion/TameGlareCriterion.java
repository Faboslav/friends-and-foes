...
public class TameGlareCriterion extends AbstractCriterion<TameGlareCriterion.Conditions>
{
	...
	public static class Conditions extends AbstractCriterionConditions
	{
		...
		public static AdvancementCriterion<TameGlareCriterion.Conditions> any() {
			return FriendsAndFoesCriterias.TAME_GLARE.create(new TameGlareCriterion.Conditions(Optional.empty(), Optional.empty()));
		}

		public static AdvancementCriterion<TameGlareCriterion.Conditions> create(EntityPredicate.Builder builder) {
			return FriendsAndFoesCriterias.TAME_GLARE.create(new TameGlareCriterion.Conditions(Optional.empty(), Optional.of(EntityPredicate.contextPredicateFromEntityPredicate(builder))));
		}
