...
public final class FriendsAndFoesItems
{
	...
	*///?}
	...
	public final static RegistryEntry<Item> WEATHERED_COPPER_BUTTON = registerItem("weathered_copper_button", () -> FriendsAndFoes.getConfig().enableCopperButtons, (properties) -> new BlockItem(FriendsAndFoesBlocks.WEATHERED_COPPER_BUTTON.get(), properties), () -> new Item.Properties().stacksTo(64));
	public final static RegistryEntry<Item> OXIDIZED_COPPER_BUTTON = registerItem("oxidized_copper_button", () -> FriendsAndFoes.getConfig().enableCopperButtons, (properties) -> new BlockItem(FriendsAndFoesBlocks.OXIDIZED_COPPER_BUTTON.get(), properties), () -> new Item.Properties().stacksTo(64));
	...
	*///?}
	...
	private static RegistryEntry<Item> registerBeehive(String id, BooleanSupplier isEnabled, RegistryEntry<Block> block) {
		...
		return registerItem(id, isEnabled, (properties) -> new BlockItem(block.get(), properties), () -> beehiveProperties);
	}
	...
	private static RegistryEntry<Item> registerItem(String id, BooleanSupplier isEnabled, Function<Item.Properties, Item> factory, Supplier<Item.Properties> getter) {
		//? if >=1.21.4 {
