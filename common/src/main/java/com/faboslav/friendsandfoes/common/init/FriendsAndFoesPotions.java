...
public final class FriendsAndFoesPotions
{
	...
	public static final HolderRegistryEntry<Potion> LONG_GLIDING = POTIONS.registerHolder("long_gliding", () -> new Potion("gliding", new MobEffectInstance(FriendsAndFoesStatusEffects.GLIDE.holder(), ((int)(FriendsAndFoes.getConfig().penguinPotionOfGlidingDuration * 2.66666666667) * 20))));
