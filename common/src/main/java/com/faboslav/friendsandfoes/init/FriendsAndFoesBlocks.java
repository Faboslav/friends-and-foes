...
public final class FriendsAndFoesBlocks
{
	...
	static {
		...
		BAMBOO_BEEHIVE = RegistryHelper.registerBlock("bamboo_beehive", () -> new BeehiveBlock(AbstractBlock.Settings.create().mapColor(MapColor.YELLOW).strength(0.6F).sounds(BlockSoundGroup.BAMBOO_WOOD).instrument(Instrument.BASS).burnable()));
		...
		CHERRY_BEEHIVE = RegistryHelper.registerBlock("cherry_beehive", () -> new BeehiveBlock(AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_WHITE).strength(0.6F).sounds(BlockSoundGroup.CHERRY_WOOD).instrument(Instrument.BASS).burnable()));
