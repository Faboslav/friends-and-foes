...
public final class ModEntityTypes
{
	...
	public static void addSpawns() {
		...
		if (config.enableGlare && config.enableGlareSpawn) {
			addSpawn(ModTags.HAS_GLARE, GLARE.get(), EnumUtils.isValidEnum(SpawnGroup.class, ExpandedEnumValues.GLARES) ? SpawnGroup.valueOf(ExpandedEnumValues.GLARES):SpawnGroup.CREATURE, config.glareSpawnWeight, config.glareSpawnMinGroupSize, config.glareSpawnMaxGroupSize);
		}
