package com.faboslav.friendsandfoes.entity.ai.control;
		...
		if (this.targetPos != null) {
			if (
				...
				&& (
					...
					|| !(new BlockPos(
						this.targetPos.getX(),
						this.entity.getY(), this.targetPos.getZ())).isWithinDistance(this.entity.getPos(), Math.max(this.entity.getWidth(), 1.0D)
					)
				)
			) {
