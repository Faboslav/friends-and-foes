...
public class Penguin extends EntityModel<Entity>
{
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData earPatches = head.addChild("earPatches", ModelPartBuilder.create().uv(0, 20).cuboid(-5.0F, -2.0F, 0.0F, 10.0F, 3.0F, 8.0F, new Dilation(0.1F)), ModelTransform.pivot(0.0F, -4.0F, -4.0F));

		ModelPartData leftWing = body.addChild("leftWing", ModelPartBuilder.create().uv(30, 25).cuboid(0.0F, -1.0F, -3.0F, 1.0F, 9.0F, 6.0F, new Dilation(0.0F)), ModelTransform.pivot(5.0F, -10.0F, -1.0F));

		ModelPartData rightWing = body.addChild("rightWing", ModelPartBuilder.create().uv(30, 25).cuboid(-1.0F, -1.0F, -3.0F, 1.0F, 9.0F, 6.0F, new Dilation(0.0F)), ModelTransform.pivot(-5.0F, -10.0F, -1.0F));

		ModelPartData leftLeg = main.addChild("leftLeg", ModelPartBuilder.create().uv(28, 0).cuboid(-1.5F, 0.0F, -5.0F, 3.0F, 1.0F, 6.0F, new Dilation(0.0F)), ModelTransform.pivot(2.5F, 13.0F, 0.0F));
