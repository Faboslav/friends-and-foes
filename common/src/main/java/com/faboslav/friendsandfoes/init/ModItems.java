...
public final class ModItems
{
	...
	static {
		...
		MAULER_SPAWN_EGG = ITEMS.register("mauler_spawn_egg", () -> new ArchitecturySpawnEggItem(ModEntity.MAULER, 0xFACA00, 0xf7EDC1, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
