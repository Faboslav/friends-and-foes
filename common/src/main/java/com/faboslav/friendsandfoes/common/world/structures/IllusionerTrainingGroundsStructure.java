...
public final class IllusionerTrainingGroundsStructure extends Structure
{
	...
	//?} else {
	/*public static final Codec<IllusionerTrainingGroundsStructure> CODEC = RecordCodecBuilder.<IllusionerTrainingGroundsStructure>create(instance ->
	*///?}
		instance.group(IllusionerTrainingGroundsStructure.settingsCodec(instance),
