...
public final class CustomSpawnGroup
{
	...
	public static final String GLARES_INTERNAL_NAME = "FRIENDSANDFOES_GLARES";
	...
	public static final String RASCALS_INTERNAL_NAME = "FRIENDSANDFOES_RASCALS";
	public static final String RASCALS_NAME = "friendsandfoes_rascals";
