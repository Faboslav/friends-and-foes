...
*///?}
{
	...
	public static LayerDefinition getTexturedModelData() {
		...
		root.addOrReplaceChild(MAIN, CubeListBuilder.create(), PartPose.offset(0.0F, 10.0F, 0.0F));
		PartDefinition main = root.getChild(MAIN);

		main.addOrReplaceChild(BODY, CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -12.0F, -5.0F, 10.0F, 12.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 13.0F, 0.0F));
		PartDefinition body = main.getChild(BODY);

		body.addOrReplaceChild(HEAD, CubeListBuilder.create().texOffs(29, 13).addBox(-4.0F, -5.0F, -4.0F, 8.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -12.0F, 0.0F));
		PartDefinition head = body.getChild(HEAD);

		head.addOrReplaceChild(BILL, CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -17.0F, -6.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 14.0F, 0.0F));
		head.addOrReplaceChild(EAR_PATCHES, CubeListBuilder.create().texOffs(0, 20).addBox(-5.0F, -2.0F, 0.0F, 10.0F, 3.0F, 8.0F, new CubeDeformation(0.1F)), PartPose.offset(0.0F, -4.0F, -4.0F));
		body.addOrReplaceChild(LEFT_WING, CubeListBuilder.create().texOffs(30, 25).addBox(0.0F, -1.0F, -3.0F, 1.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(5.0F, -10.0F, -1.0F));
		body.addOrReplaceChild(RIGHT_WING, CubeListBuilder.create().texOffs(30, 25).addBox(-1.0F, -1.0F, -3.0F, 1.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, -10.0F, -1.0F));
		main.addOrReplaceChild(LEFT_LEG, CubeListBuilder.create().texOffs(28, 0).addBox(-1.5F, 0.0F, -5.0F, 3.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(2.5F, 13.0F, 0.0F));
		main.addOrReplaceChild(RIGHT_LEG, CubeListBuilder.create().texOffs(28, 0).addBox(-1.5F, 0.0F, -5.0F, 3.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.5F, 13.0F, 0.0F));
