...
public final class CompleteHideAndSeekGameCriterion extends AbstractCriterion<CompleteHideAndSeekGameCriterion.Conditions>
{
	...
	public static class Conditions extends AbstractCriterionConditions
	{
		...
		public static AdvancementCriterion<CompleteHideAndSeekGameCriterion.Conditions> any() {
			return FriendsAndFoesCriterias.COMPLETE_HIDE_AND_SEEK_GAME.create(new CompleteHideAndSeekGameCriterion.Conditions(Optional.empty(), Optional.empty()));
		}

		public static AdvancementCriterion<CompleteHideAndSeekGameCriterion.Conditions> create(EntityPredicate.Builder builder) {
			return FriendsAndFoesCriterias.COMPLETE_HIDE_AND_SEEK_GAME.create(new CompleteHideAndSeekGameCriterion.Conditions(Optional.empty(), Optional.of(EntityPredicate.contextPredicateFromEntityPredicate(builder))));
		}
