		...
		if (
			...
			for (int attempt = 0; attempt < 10; attempt++) {
				...
				mutable.set(glare.getBlockPos()).set(
					this.glare.getBlockPos().getX() + this.glare.getRandom().nextInt(-blockRange, blockRange),
					this.glare.getRandom().nextInt(currentGroundBlockPosY - blockRange, currentGroundBlockPosY + blockRange),
					this.glare.getBlockPos().getZ() + this.glare.getRandom().nextInt(-blockRange, blockRange)
				);
