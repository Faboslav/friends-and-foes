...
public final class IceologerEntity extends SpellcastingIllagerEntity
{
	...
	public SoundEvent getCelebratingSound() {
		return ModSoundEvents.ENTITY_ICEOLOGER_AMBIENT.get();
	}
	...
	protected SoundEvent getDeathSound() {
		return ModSoundEvents.ENTITY_ICEOLOGER_DEATH.get();
	}

	protected SoundEvent getHurtSound(DamageSource source) {
		return ModSoundEvents.ENTITY_ICEOLOGER_HURT.get();
	}

	protected SoundEvent getCastSpellSound() {
		return ModSoundEvents.ENTITY_ICEOLOGER_CAST_SPELL.get();
	}
	...
	private class SummonIceChunkGoal extends CastSpellGoal
	{
		...
		protected SoundEvent getSoundPrepare() {
			return ModSoundEvents.ENTITY_ICEOLOGER_PREPARE_SUMMON.get();
		}
	...
	public final class SlowTargetGoal extends CastSpellGoal
	{
		...
		@Override
		protected SoundEvent getSoundPrepare() {
			return ModSoundEvents.ENTITY_ICEOLOGER_PREPARE_SLOWNESS.get();
		}
