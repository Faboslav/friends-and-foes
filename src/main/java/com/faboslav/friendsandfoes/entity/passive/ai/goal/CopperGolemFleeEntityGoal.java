...
public class CopperGolemFleeEntityGoal extends FleeEntityGoal
{
    ...
    public boolean canStart() {
        ...
        TargetPredicate withinRangePredicate = TargetPredicate.createNonAttackable().setBaseMaxDistance((double)this.fleeDistance).setPredicate(inclusionSelector.and(extraInclusionSelector));
