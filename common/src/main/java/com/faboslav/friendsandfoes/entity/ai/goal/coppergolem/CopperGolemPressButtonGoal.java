...
public final class CopperGolemPressButtonGoal extends Goal
{
	...
	public void stop() {
		...
		int minCooldownTicks = CopperGolemEntity.MIN_TICKS_UNTIL_CAN_PRESS_BUTTON;
	...
	public void tick() {
		...
		if (
			this.standingNearToCopperButtonTicks >= this.idleTicksBeforeButtonPress / 3
			&& this.copperGolem.isPressingButton() == false
		) {
