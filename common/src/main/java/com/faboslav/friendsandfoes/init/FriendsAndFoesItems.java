...
public final class FriendsAndFoesItems
{
	...
	static {
		...
		WILDFIRE_SPAWN_EGG = RegistryHelper.registerItem("wildfire_spawn_egg", () -> new DispensableSpawnEggItem(FriendsAndFoesEntityTypes.WILDFIRE, 0xf7EDC1, 0xFACA00, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
