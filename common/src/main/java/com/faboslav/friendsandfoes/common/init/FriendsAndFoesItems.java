...
public final class FriendsAndFoesItems
{
	...
	public final static RegistryEntry<Item> WILDFIRE_CROWN = ITEMS.register("wildfire_crown", () ->  new ArmorItem(FriendsAndFoesArmorMaterials.WILDFIRE.reference(), ArmorItem.Type.HELMET, (new Item.Settings().maxCount(1)).fireproof().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(37))));
