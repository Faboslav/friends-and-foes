...
public class FriendsAndFoesBiomeModifiers
{
	...
	public static final DeferredHolder<Codec<? extends BiomeModifier>, Codec<MobSpawnsBiomeModifier>> BIOME_MODIFIER = BIOME_MODIFIERS.register("mob_spawns", () -> MobSpawnsBiomeModifier.CODEC);
}