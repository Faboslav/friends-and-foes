...
public final class FriendsAndFoesEntityTypes
{
	...
	static {
		...
		WILDFIRE = RegistryHelper.registerEntityType("wildfire", () -> EntityType.Builder.create(WildfireEntity::new, SpawnGroup.MONSTER).setDimensions(0.8F, 1.875F).maxTrackingRange(10).build(FriendsAndFoes.makeStringID("wildfire")));
