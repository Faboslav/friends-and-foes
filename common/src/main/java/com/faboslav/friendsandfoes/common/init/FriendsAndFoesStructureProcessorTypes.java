...
{
	public static final ResourcefulRegistry<StructureProcessorType<?>> STRUCTURE_PROCESSOR = ResourcefulRegistries.create(Registries.STRUCTURE_PROCESSOR, FriendsAndFoes.MOD_ID);
