...
public class MaulerEntityRenderer extends MobEntityRenderer<MaulerEntity, MaulerEntityModel<MaulerEntity>>
{
	...
	@Override
	public Identifier getTexture(MaulerEntity entity) {
		return FriendsAndFoes.makeID("textures/entity/mauler/mauler.png");
	}
}