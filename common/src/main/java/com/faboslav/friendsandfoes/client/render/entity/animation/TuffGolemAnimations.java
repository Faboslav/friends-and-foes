...
public final class TuffGolemAnimations
{
	...
	static {
		SHOW_ITEM = new KeyframeAnimation("show_item", Animation.Builder.create(0.4583333333333333F).addBoneAnimation("clothStand",
			new Transformation(
		...
		HIDE_ITEM = new KeyframeAnimation("hide_item", Animation.Builder.create(0.4583333333333333F).addBoneAnimation("clothStand",
			new Transformation(
				Transformation.Targets.ROTATE,
				new Keyframe(0F, AnimationHelper.createRotationalVector(0F, 0F, 0F), Transformation.Interpolations.LINEAR),
