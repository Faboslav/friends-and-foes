...
public final class IceologerCabinStructure extends Structure
{
	...
	//?} else {
	/*public static final Codec<IceologerCabinStructure> CODEC = RecordCodecBuilder.create(instance ->
	*///?}
		instance.group(IceologerCabinStructure.settingsCodec(instance),
