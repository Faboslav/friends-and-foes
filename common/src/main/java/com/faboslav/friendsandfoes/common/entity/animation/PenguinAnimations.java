...
public final class PenguinAnimations
{
	...
	public static final AnimationHolder WING_FLAP = AnimationLoader.INSTANCE.getAnimationHolder(FriendsAndFoes.makeID("penguin/wing_flap"));
