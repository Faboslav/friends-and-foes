...
public final class FriendsAndFoesEntityTypes
{
	...
	static {
		...
		TUFF_GOLEM = RegistryHelper.registerEntityType("tuff_golem", () -> EntityType.Builder.create(TuffGolemEntity::new, SpawnGroup.MISC).setDimensions(0.75F, 1.0625F).maxTrackingRange(10).makeFireImmune().build(FriendsAndFoes.makeStringID("tuff_golem")));
